...
<section class="auth-box">
    <h1>Editar oferta</h1>
    <p>Los cambios se aplican manteniendo el estado actual de la oferta.</p>
    ...
    <form method="post" action="<?= BASE_URL; ?>/admin/job-edit.php?id=<?= $jobId; ?>" class="auth-form" novalidate id="form-job">
        ...
        <a href="<?= BASE_URL; ?>/admin/job-detail.php?id=<?= $jobId; ?>" class="btn-link btn-cancel">Cancelar</a>
    </form>
</section>
